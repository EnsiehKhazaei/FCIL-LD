...
def start():
    ...
    parser.add_argument('--eval_int', type=int, default=50)#100)#100, help='Evaluation intervals')
    parser.add_argument('--global_round', type=int, default=50)#100)#100, help='#global rounds per task')
